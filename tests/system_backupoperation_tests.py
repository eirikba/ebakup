...
class TestSimpleBackup(unittest.TestCase):
    def setUp(self):
        ...
        collection = backupcollection.BackupCollection.create(params)
        ...
        self.collection2 = backupcollection.BackupCollection(params)
    ...
    def test_shadow_tree_is_linked_correctly(self):
        ...
        for path in (
            ...
            contentpath = self.collection2._make_path_from_content_id(cid)
